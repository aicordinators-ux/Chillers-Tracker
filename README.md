...
6. لو "تم الزيارة" → يلتقط **صورة الثلاجة**
7. **💾 حفظ** → البيانات بتترفع على Firebase فوراً
...
- **📊 التقدم**: نسبة إنجاز كل عربية + Export Excel + Export الصور كـ ZIP
...
### حجم الصور
الصور بتنضغط تلقائي إلى 1024px max + JPEG quality 70% قبل ما ترفع. الصورة الواحدة بتطلع تقريباً 80-200KB.
...
لو الصور بتزيد على المساحة، الحل الأمثل هو **Firebase Storage** بدل ما تتحفظ كـ base64 في الـ DB. لو احتجت ده، قولي وهضيفه.
...
| الصور مش بتظهر بعد الحفظ | الصورة محفوظة كـ base64 — افتح نفس الكارت تاني هتلاقيها |
